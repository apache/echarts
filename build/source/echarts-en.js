...
define('zrender/zrender', [
    ...
    Text.prototype = {
        ...
        brush: function (ctx, isHighlight) {
            ...
            var lineHeight = area.getTextHeight('Country', style.textFont);
    ...
    function getTextHeight(text, textFont) {
        ...
        text = (text + '').split('\n');
        var height = (_ctx.measureText('Country').width + 2) * text.length;
        _ctx.restore();
    ...
    function _fillText(ctx, text, x, y, textFont, textAlign, textBaseline) {
        ...
        text = (text + '').split('\n');
        var lineHeight = require('../tool/area').getTextHeight('Country', textFont);
        switch (textBaseline) {
        case 'top':
            y = rect.y;
            break;
    ...
    function _getTextRect(text, x, y, textFont, textAlign, textBaseline) {
        ...
        var lineHeight = area.getTextHeight('Country', textFont);
        text = (text + '').split('\n');
        switch (textAlign) {
        case 'end':
        case 'right':
