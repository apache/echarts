...
define(function (require) {
    var animationBase = {
        pointList : function (zr, oldShape, newShape, duration, easing) {
        ...
        rectangle : function (zr, oldShape, newShape, duration, easing) {
        ...
        candle : function (zr, oldShape, newShape, duration, easing) {
            var newY = newShape.style.y;
            newShape.style.y = oldShape.style.y;
            zr.addShape(newShape);
            zr.animate(newShape.id, 'style')
        ...
        ring : function (zr, oldShape, newShape, duration, easing) {
        ...
        sector : function (zr, oldShape, newShape, duration, easing) {
        ...
        text : function (zr, oldShape, newShape, duration, easing) {
            var x = newShape.style.x;
            var y = newShape.style.y;
        ...
        polygon : function (zr, oldShape, newShape, duration, easing) {
        ...
        chord : function (zr, oldShape, newShape, duration, easing) {
            //var rect = require('zrender/shape/Polygon').prototype.getRect(newShape.style);
